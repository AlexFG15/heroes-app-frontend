...
import { FavoriteHeroeProvider } from "../context/FavoriteHeroeContext";
...
describe("HeroStats", () => {
  test("should render componnet with default values", () => {
  ...
  test("should render HeroStats with mock infromation", () => {
